...
ChartContainer.propTypes = {
   ...
   * on the timeRange prop and there is no need to set this. Current d3 is
   * used to generate this.
   *
   * Four special options exist: setting format to "day", "month" or
   ...
   *
   * The last special option is "relative". This interprets the time as a duration. This
   * is good for data that is specified relative to its start time, rather than
   * as an actual date/time.
   * 
   * If you provide a string other than the above options, this will be interpreted
   * as a [d3.format](https://github.com/d3/d3-time-format/blob/master/README.md#timeFormat).
   * While if you supply a function that will be called with the `Date`, from which you
   * can return whatever string you want.
   * 
   * Note that these options generally allow you to format the date tick, but in general
   * don't allow a lot of control of tick placement.
   */
