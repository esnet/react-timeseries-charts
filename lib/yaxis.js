...
exports.default = _react2.default.createClass({
    ...
    updateAxis: function updateAxis(align, scale, width, absolute, fmt) {
        var yformat = (0, _d3Format.format)(fmt);
        var axis = align === "left" ? _d3Axis.axisLeft : _d3Axis.axisRight;
        ...
        (0, _d3Selection.select)(_reactDom2.default.findDOMNode(this)).select(".yaxis").transition().duration(this.props.transition).ease("sin-in-out").call(axisGenerator);
    },
