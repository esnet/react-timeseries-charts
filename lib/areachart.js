...
function getAreaGenerators(interpolate, timeScale, yScale) {
    var upArea = _d2.default.svg.area().x(function (d) {
    ...
    var downArea = _d2.default.svg.area().x(function (d) {
        return timeScale(d.date);
    }).y0(function (d) {
        return yScale(d.y0);
    }).y1(function (d) {
...
function getAreaStackers() {
    return {
        stackUp: _d2.default.layout.stack().values(function (d) {
            return d.values;
        }).x(function (d) {
            return d.date;
        }).y(function (d) {
        ...
        stackDown: _d2.default.layout.stack().values(function (d) {
            return d.values;
        }).x(function (d) {
            return d.date;
        }).y(function (d) {
...
exports.default = _react2.default.createClass({
    ...
    renderAreaChart: function renderAreaChart(series, timeScale, yScale, interpolate, isPanning, columns, width, style) {
        ...
        var upChart = _d2.default.select(_reactDom2.default.findDOMNode(this)).selectAll(".areachart-up-group").data(upLayers).enter().append("g").attr("id", function () {
        ...
        var downChart = _d2.default.select(_reactDom2.default.findDOMNode(this)).selectAll(".areachart-down-group").data(downLayers).enter().append("g").attr("id", function () {
