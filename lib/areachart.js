...
exports["default"] = _react2["default"].createClass({
    ...
    renderAreaChart: function renderAreaChart(series, timeScale, yScale, interpolate, isPanning, columns, width) {
        var _this = this;
    ...
    componentDidMount: function componentDidMount() {
        this.renderAreaChart(this.props.series, this.props.timeScale, this.props.yScale, this.props.interpolate, this.props.isPanning, this.props.columns);
    },
    ...
    componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
        ...
        if (seriesChanged || timeScaleChanged || widthChanged || interpolateChanged || isPanningChanged || columnsChanged) {
            this.renderAreaChart(newSeries, timeScale, yScale, interpolate, isPanning, columns, width);
