...
exports.default = _react2.default.createClass({
    ...
    propTypes: {
        ...
        style: _react2.default.PropTypes.oneOf([_react2.default.PropTypes.object, _react2.default.PropTypes.func, _react2.default.PropTypes.instanceOf(_styler.Styler)]).isRequired,
    ...
    providedStyle: function providedStyle(category) {
        var style = {};
        console.log("providedStyle", category.key, this.props.style);
        if (this.props.style) {
    ...
    styleMode: function styleMode(category) {
        console.log("getting StyleMode", category);
    ...
    symbolStyle: function symbolStyle(category) {
        console.log("symbolStyle", category);
    ...
    render: function render() {
        ...
        var items = this.props.categories.map(function (category) {
            ...
            console.log(">>>", symbolStyle, labelStyle, valueStyle);
