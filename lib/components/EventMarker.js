  ...
  _createClass(EventMarker, [{
    ...
    value: function renderMarker(event, column, info) {
      ...
      if (this.props.type === "point") {
        ...
        var tstyle = this.props.markerLabelAlign === "center" ? textStyleCentered : textStyle;
        ...
        label = _react2.default.createElement(
          "text",
          { x: posx, y: posy, dx: "5px", style: tstyle },
...
EventMarker.propTypes = {
  type: _react2.default.PropTypes.oneOf(["point", "flag"]),

  /**
   * What [Pond Event](http://software.es.net/pond#event) to mark
   */
  event: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.instanceOf(_pondjs.TimeEvent), _react2.default.PropTypes.instanceOf(_pondjs.IndexedEvent), _react2.default.PropTypes.instanceOf(_pondjs.TimeRangeEvent)]),
  /**
   ...
   */
  markerLabelAlign: _react2.default.PropTypes.oneOf(["left", "right", "top"]),
  /**
   ...
   */
  markerStyle: _react2.default.PropTypes.object,
  /**
