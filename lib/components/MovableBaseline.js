...
/**
 *
 * The MovableBaseline component displays a simple horizontal line at a value.
 *
 * For example the following code overlays MovableBaselines for the mean and stdev
 ...
 *             <MovableBaseline axis="price" value={series.avg()} label="Avg" position="right" />
 *             <MovableBaseline axis="price" value={series.avg()-series.stdev()} />
 *             <MovableBaseline axis="price" value={series.avg()+series.stdev()} />
 *         </Charts>
 *     </ChartRow>
 * </ChartContainer>
...
var MovableBaseline = function (_React$Component) {
    _inherits(MovableBaseline, _React$Component);

    function MovableBaseline() {
        _classCallCheck(this, MovableBaseline);

        return _possibleConstructorReturn(this, (MovableBaseline.__proto__ || Object.getPrototypeOf(MovableBaseline)).apply(this, arguments));
    }

    _createClass(MovableBaseline, [{
        key: "render",
        value: function render() {
            ...
            var y = yScale(value);
            console.log("yScale", "y value", value, "y axis", y);
            ...
            var alignmentMovableBaseline = labelBelow ? "hanging" : "auto";
            ...
            var baseLabelStyle = _extends({}, defaultStyle.label, { alignmentMovableBaseline: alignmentMovableBaseline });
    ...
    return MovableBaseline;
}(_react2.default.Component);

exports.default = MovableBaseline;


MovableBaseline.defaultProps = {
    visible: true,
    value: 0,
    label: "",
    position: "left",
