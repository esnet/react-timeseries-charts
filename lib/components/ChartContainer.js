        ...
        },
        {
            ...
            value: function render() {
                ...
                _react2.default.Children.forEach(this.props.children, function(childRow) {
                    console.log("here ", childRow.type, _ChartRow2.default);
                    var element = _react2.default.createElement(_ChartRow2.default, null);
                    if (
                    ...
                    if (childRow.type === _react2.default.createElement(_ChartRow2.default).type) {
                        console.log("createElement works");
                    }

                    var ChartRowType = _react2.default.createElement(_ChartRow2.default, null).type;
