...
var ChartRow = function (_React$Component) {
  ...
  function ChartRow(props) {
    ...
    // each render.
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChartRow).call(this, props));
        ...
        if (child.type === _Charts2.default) {
          ...
          _react2.default.Children.forEach(_charts.props.children, function (chart) {
            var chartProps = {
              ...
              yScale: _this4.state.yAxisScalerMap[chart.props.axis],
              transition: _this4.scaleMap[chart.props.axis].transition()
            };
...
ChartRow.propTypes = {
  ...
  leftAxisWidths: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.number),

  rightAxisWidths: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.number),

  width: _react2.default.PropTypes.number,

  timeScale: _react2.default.PropTypes.func,

  trackerTimeFormat: _react2.default.PropTypes.string,

  timeFormat: _react2.default.PropTypes.string,

  trackerTime: _react2.default.PropTypes.instanceOf(Date),

  /**
   * Should the time be shown on top of the tracker info box
   */
  trackerShowTime: _react2.default.PropTypes.bool,

  /**
   * The width of the tracker info box
   */
  trackerInfoWidth: _react2.default.PropTypes.number,

  /**
   * The height of the tracker info box
   */
  trackerInfoHeight: _react2.default.PropTypes.number,
   ...
   */
  trackerInfoValues: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.string, _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.shape({
