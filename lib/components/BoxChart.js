...
function getAggregatedSeries(series, column) {
  var aggregation = arguments.length <= 2 || arguments[2] === undefined ? defaultAggregation : arguments[2];
  var size = aggregation.size;
  var reducers = aggregation.reducers;
  var inner = reducers.inner;
  var outer = reducers.outer;
  var center = reducers.center;
...
var BoxChart = function (_React$Component) {
  ...
  function BoxChart(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BoxChart).call(this, props));

    if (props.series._collection._type === _pondjs.Event) {
      // eslint-disable-line
...
BoxChart.propTypes = {
   ...
   * ```
   */
  aggregation: _react2.default.PropTypes.shape({
    size: _react2.default.PropTypes.string,
    reducers: _react2.default.PropTypes.shape({
      inner: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.func), // eslint-disable-line
      outer: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.func), // eslint-disable-line
      center: _react2.default.PropTypes.func })
  }), // eslint-disable-line
   ...
   */
  info: _react2.default.PropTypes.arrayOf( //eslint-disable-line
   ...
   * separately.
   */
  innerSpacing: _react2.default.PropTypes.number,
   ...
   * separately.
   */
  outerSpacing: _react2.default.PropTypes.number,
   ...
   */
  selected: _react2.default.PropTypes.instanceOf(_pondjs.IndexedEvent),
   ...
   */
  highlighted: _react2.default.PropTypes.instanceOf(_pondjs.IndexedEvent),
