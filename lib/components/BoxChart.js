...
function getAggregatedSeries(series, column) {
    var aggregation = arguments.length > 2 && arguments[2] !== undefined
        ? arguments[2]
        : defaultAggregation;
        ...
        },
        {
            ...
            value: function style(column, event, level) {
                ...
                var isHighlighted = this.props.highlighted &&
                    _pondjs.Event.is(this.props.highlighted, event);

                var isSelected = this.props.selected &&
                    _pondjs.Event.is(this.props.selected, event);
            ...
            value: function renderBars() {
                ...
                try {
                    var _loop = function _loop() {
                        ...
                        var isHighlighted = _this2.props.highlighted &&
