...
var BoxChart = function (_React$Component) {
  ...
  _createClass(BoxChart, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      if (seriesChanged) {
        if (this.props.series._collection._type === _pondjs.TimeEvent // eslint-disable-line
        ) {
            this.series = getAggregatedSeries(this.props.series, this.props.column, this.props.aggregation);
          } else {
...
BoxChart.propTypes = {
  ...
  aggregation: _react2.default.PropTypes.shape({
    ...
    reducers: _react2.default.PropTypes.shape({
      ...
      center: _react2.default.PropTypes.func // eslint-disable-line
    })
  }), // eslint-disable-line
  /**
   ...
   */
  info: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.shape({ //eslint-disable-line
