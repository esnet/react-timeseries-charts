...
var EventChart = function (_React$Component) {
  ...
  function EventChart(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EventChart).call(this, props));
  ...
  _createClass(EventChart, [{
    key: 'handleMouseMove',
    value: function handleMouseMove(e, event) {
    ...
    value: function render() {
      ...
      try {
        var _loop = function _loop() {
          ...
          var isHover = _this2.state.hover ? event.data() === _this2.state.hover.data() : false;
          ...
          var label = _this2.props.label(event);
          ...
          eventMarkers.push(_react2.default.createElement(
            'g',
            { transform: transform, key: markerKey },
            _react2.default.createElement('rect', {
              className: 'eventchart-marker',
              ...
              onMouseMove: function onMouseMove(e) {
                return _this2.handleMouseMove(e, event);
              }
            }),
            text
          ));
