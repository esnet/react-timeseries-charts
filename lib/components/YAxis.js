...
var YAxis = function (_React$Component) {
    ...
    _createClass(YAxis, [{
        ...
        value: function postSelect(style, hideAxisLine, height) {
            ...
            var el = (0, _d3Selection.select)(_reactDom2.default.findDOMNode(this)).select("g").selectAll(".tick").select("text");
            ...
            Object.entries(valueStyle).forEach(function (_ref) {
                ...
                return el.attr(prop, val);
            });

            el = (0, _d3Selection.select)(_reactDom2.default.findDOMNode(this)).select("g").selectAll(".tick").select("line");
            ...
            if (!hideAxisLine) {
                el = (0, _d3Selection.select)(_reactDom2.default.findDOMNode(this)).select("g").append("line").attr("x1", 0).attr("y1", 0).attr("x2", 0).attr("y2", height);
        ...
        value: function renderAxis(align, scale, width, height, showGrid, chartExtent, hideAxisLine, absolute, type, fmt, label, tickCount, min, max) {
            ...
            Object.entries(valueStyle).forEach(function (_ref7) {
                ...
                return _this2.axis.attr(prop, val);
            });
