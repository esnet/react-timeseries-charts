    ...
    _createClass(YAxis, [
        ...
        },
        {
            ...
            value: function updateAxis(align, scale, width, absolute, type, fmt) {
                ...
                var valueStyle = (0, _merge2.default)(
                    true,
                    defaultStyle.values,
                ...
                var valueColor = valueStyle.valueColor;
