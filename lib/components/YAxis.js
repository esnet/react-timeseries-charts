...
exports.default = _react2.default.createClass({
    ...
    updateAxis: function updateAxis(align, scale, width, absolute, type, fmt) {
        ...
        var t = (0, _d3Transition.transition)().duration(750).ease(_d3Ease.easeSinOut);
