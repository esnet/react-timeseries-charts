    ...
    _createClass(Styler, [{
        ...
        value: function lineChartStyle() {
            ...
            _underscore2.default.forEach(this._columnStyles, function (_ref2, column) {
                ...
                var i = _underscore2.default.indexOf(_this2._columnNames, column);
                var c = color ? color : colorLookup[i % colorLookup.length];
                var styleLine = {
                    stroke: c,
                    strokeWidth: width,
        ...
        value: function barChartStyle() {
            ...
            _underscore2.default.forEach(this._columnStyles, function (_ref3, column) {
                ...
                var i = _underscore2.default.indexOf(_this3._columnNames, column);
                var c = color ? color : colorLookup[i % colorLookup.length];
                var fillStyle = {
                    fill: c
                };
        ...
        value: function scatterChartStyle() {
            ...
            _underscore2.default.forEach(this._columnStyles, function (_ref4, column) {
                ...
                var i = _underscore2.default.indexOf(_this4._columnNames, column);
                var c = color ? color : colorLookup[i % colorLookup.length];
                var fillStyle = {
                    fill: c
                };
