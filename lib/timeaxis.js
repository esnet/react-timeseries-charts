...
exports.default = _react2.default.createClass({
    ...
    renderTimeAxis: function renderTimeAxis(scale) {
        ...
        if (this.props.format === "day") {
            ...
            axis = _d2.default.svg.axis().scale(scale).tickSize(-100, 0, 0).orient("bottom");
        }
        ...
        // Draw the new axis
        _d2.default.select(_reactDom2.default.findDOMNode(this)).append("g").attr("class", "x axis").call(axis.tickSize(tickSize));
    },
