...
exports.default = _react2.default.createClass({
    ...
    render: function render() {
        ...
        var _props$timeRange$toJS = this.props.timeRange.toJSON();

        var _props$timeRange$toJS2 = _slicedToArray(_props$timeRange$toJS, 2);

        var beginTime = _props$timeRange$toJS2[0];
        var endTime = _props$timeRange$toJS2[1];


        var timeScale = _d3.default.time.scale().domain([beginTime, endTime]).range([0, timeAxisWidth]);
        ...
        var tracker = _react2.default.createElement(
            ...
            _react2.default.createElement(_tracker2.default, { height: yPosition,
                timeScale: timeScale,
