...
exports["default"] = _reactAddons2["default"].createClass({
    ...
    render: function render() {
            ...
            if (childRow.type === _chartrow2["default"]) {
                (function () {
                    ...
                    if (countCharts !== 1) {
                        ...
                        (0, _reactLibInvariant2["default"])(false, msg, childRow.constructor.name);
                    }
        ...
        var timeaxis = _reactAddons2["default"].createElement(_timeaxis2["default"], { scale: timeScale, format: this.props.format });
