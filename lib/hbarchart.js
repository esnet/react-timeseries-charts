...
var Bars = _react2.default.createClass({
    ...
    render: function render() {
        ...
        var columnElements = columns.map(function (column, i) {
            ...
            // Scale
            var scale = _d2.default.scale.linear().domain([0, max]).range([0, width - 100]);
            ...
            switch (display) {
                ...
                case "max":
                    ...
                    if (format && _underscore2.default.isString(format)) {
                        var formatter = _d2.default.format(format);
...
exports.default = _react2.default.createClass({
    ...
    renderRows: function renderRows(seriesList) {
        ...
        var onNavigate = _props3.onNavigate;
        var navigateColor = _props3.navigateColor;
