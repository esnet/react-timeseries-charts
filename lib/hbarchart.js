...
var RangeBar = _react2.default.createClass({

    displayName: "RangeBar",

    shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
        var seriesChanged = !_pondjs.TimeSeries.is(this.props.series, nextProps.series);
        var scaleChanged = scaleAsString(this.props.scale) !== scaleAsString(nextProps.scale);
    ...
    render: function render() {
        ...
        var barElementBackground = _react2.default.createElement("rect", { style: bgstyle, rx: 2, ry: 2, x: start, y: 1, width: backgroundWidth, height: size - 2 });
        var barElementCenter = _react2.default.createElement("rect", { style: fgstyle, x: centerStart, y: 0, width: centerWidth, height: size });
