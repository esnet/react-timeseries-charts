    ...
    render: function render() {
        ...
        for (var leftColumnIndex = 0; leftColumnIndex < this.props.leftAxisWidths.length; leftColumnIndex++) {
            ...
            if (leftColumnIndex < leftAxisList.length) {
                ...
                // Cloned left axis
                axis = (0, _reactAddonsCloneWithProps2["default"])(yAxisMap[id], props);
        ...
        _react2["default"].Children.forEach(this.props.children, function (child) {
            ...
            if (child.type === _charts3["default"]) {
                ...
                _react2["default"].Children.forEach(_charts.props.children, function (chart) {
                    ...
                    chartList.push((0, _reactAddonsCloneWithProps2["default"])(chart, chartProps));
        ...
        _react2["default"].Children.forEach(this.props.children, function (child) {
            if (child.type === _brush2["default"]) {
                ...
                brushList.push((0, _reactAddonsCloneWithProps2["default"])(child, brushProps));
            }
            keyCount++;
        });

        // Hover tracker line
        var tracker = _react2["default"].createElement(
            "g",
            { key: "tracker-group", style: { pointerEvents: "none" } },
            _react2["default"].createElement(_tracker2["default"], { height: innerHeight,
        ...
        if (this.props.enablePanZoom || this.props.onTrackerChanged) {
            charts = _react2["default"].createElement(
                "g",
        ...
        // Clipping
        var clipDefs = _react2["default"].createElement(
            "defs",
            null,
            _react2["default"].createElement(
                "clipPath",
