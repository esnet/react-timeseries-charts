    ...
    renderLine: function renderLine(column) {
        ...
        if (this.props.breakLine) {
            (function () {
                ...
                _underscore2.default.each(_this2.props.series.collection().events(), function (d) {
                    ...
                    if (!badPoint) {
                        ...
                        if (currentPoints) {
                            if (points.length > 1) pathLines.push(_this2.renderPath(currentPoints, column, count++));
                            currentPoints = null;
                        }
                    }
                });
                if (currentPoints && currentPoints.length > 1) {
                    pathLines.push(_this2.renderPath(currentPoints, column, count));
                }
            })();
        } else {
            (function () {
                ...
                pathLines.push(_this2.renderPath(cleanedPoints, column, count));
            })();
        }
