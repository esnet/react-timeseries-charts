...
exports["default"] = _react2["default"].createClass({
                ...
                _underscore2["default"].each(_this.props.series.toJSON().points, function (d) {
                    ...
                    if (!badPoint) {
                        ...
                        if (currentPoints) {
                            ...
                            if (points.length > 1) {
                                pathLines.push(_react2["default"].createElement("path", {
                                    key: count++,
                                    style: _this.pathStyle(),
                                    d: _this.generatePath(points),
    ...
    shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
        ...
        return seriesChanged || timeScaleChanged || interpolateChanged || isPanningChanged || yAxisScaleChanged;
    },
