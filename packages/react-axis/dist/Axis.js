...
var Axis = (function (_super) {
    ...
    Axis.prototype.renderAxisTicks = function () {
        ...
        return scale.ticks(this.props.tickCount).map(function (tickValue, tickIndex) {
            ...
            return (React.createElement(Tick_1.Tick, { id: "tick-" + tickIndex, key: tickValue, align: _this.props.position, label: label, labelAlign: "center", position: tickPosition, size: _this.props.tickSize, extend: _this.props.tickExtend, width: _this.props.width, height: _this.props.height }));
        });
    };
