        ...
        value: function renderScatter() {
            ...
            this.props.columns.forEach(function (column) {
                ...
                try {
                    ...
                    for (var _iterator3 = series.collection().eventList()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        _loop();
                    }
                } catch (err) {
