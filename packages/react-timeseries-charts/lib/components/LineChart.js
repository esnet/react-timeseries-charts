        ...
        */
        ...
        value: function renderLine(column) {
            ...
            if (this.props.breakLine) {
                ...
                try {
                    for (var _iterator = this.props.series.collection().eventList()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var d = _step.value;
                ...
                try {
                    for (var _iterator2 = this.props.series.collection().eventList()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                        var _d = _step2.value;
