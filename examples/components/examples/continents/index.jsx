...
export default React.createClass({
    ...
    render() {
        ...
        const styler = Styler(columnNames, this.state.scheme);

        const legendCategories = columnNames.map(d => ({
            key: d,
            label: d,
            style: styler.legendStyle(d, "dot")
        }));
            ...
            <div>
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <Legend categories={legendCategories} style={styler} type="dot"/>
                    </div>
                </div>
                <hr />
                <div className="row">
